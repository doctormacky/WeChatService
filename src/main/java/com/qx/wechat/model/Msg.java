...
public class Msg {
	...
	public String toString() {
		return "Msg [requestId=" + requestId + ", msgId=" + msgId + ", type=" + type + ", msgType=" + msgType
				+ ", robotWxid=" + robotWxid + ", fromWxid=" + fromWxid + ", fromName=" + fromName + ", finalFromWxid="
				+ finalFromWxid + ", finalFromName=" + finalFromName + ", msg=" + msg + ", msgTime=" + msgTime
				+ ", fileUrl=" + fileUrl + "]";
	}
